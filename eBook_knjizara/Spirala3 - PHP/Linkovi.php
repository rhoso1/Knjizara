     ...
     <div class="red">
	   ...
	   <div class="red">
	     <div class="Kolona jedan">
		  ...
		  <div class="red">
		    <div class="Kolona jedan">
			  <p class="paragraf">Pratite nas i na slijedećim stranicama: </p>
			</div>
		  ...
		  <div class="red">
		    <div class="Kolona jedan">
			 <div class="Link">
			  <ul>
			   <li><a href="https://www.facebook.com/">Facebook-u</a></li>
		       <li><a href="https://twitter.com/">Twitter-u</a></li>
               <li><a href="https://www.instagram.com/">Instagram-u</a></li>
             </ul>
			</div>
			</div>
		  </div>
