function Promijeni()
{
	var _novost = document.getElementById("novosti").value;
	if(_novost == "sve")
	{
		window.open("SveNovosti.html");
	}
	if(_novost== "danasnje")
	{
		window.open("DanasnjeNovosti.html");
	}
	if(_novost == "sedmicne")
	{
		window.open("SedmicneNovosti.html");
	}
	if(_novost == "mjesecne")
	{
		window.open("MjesecneNovosti.html");
	}
}
function Objava()
{
